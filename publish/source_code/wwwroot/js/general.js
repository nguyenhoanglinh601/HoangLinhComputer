...
function navigateCart() {
    ...
    $.post("/Carts/AddProduct",
        ...
        function () {
            window.location.replace("https://hoanglinh.tk/carts");
        });
}

function navigateOrder() {
    sessionStorage.setItem("current_page", "https://hoanglinh.tk/Orders");
    window.location.replace("https://hoanglinh.tk/Orders");
}
